 ...
 * Кнопка підтримки проєкту ("Пригостити розробника кавою")
 * Веде на Банку Monobank у новій вкладці.
 */
export default function DonateButton({ className = "", variant = "default" }) {
  return (
    <a
      ...
      aria-label="Пригостити розробника кавою через Monobank"
      title="Підтримати проєкт (Monobank)"
    >
      {/* Легкий відблиск при наведенні */}
